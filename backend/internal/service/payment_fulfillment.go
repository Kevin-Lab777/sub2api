...
func (s *PaymentService) doBalance(ctx context.Context, o *dbent.PaymentOrder, lease *paymentFulfillmentLease) error {
	// [LITE:DELETED] Balance recharge depends on the removed redeem-code domain.
	return infraerrors.Forbidden("BALANCE_RECHARGE_DISABLED", "balance recharge is not available in Lite")
}
