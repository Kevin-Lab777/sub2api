...
// [LITE:MODIFY] doBalance — credit user balance directly via userRepo.
// Idempotency comes from ExecuteBalanceFulfillment's RECHARGING state guard.
// [LITE:DELETED] redeemAction / resolveRedeemAction — RedeemService removed.
