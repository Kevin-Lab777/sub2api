...
import (
	...
	httppool "github.com/Kevin-Lab777/sub2api/internal/pkg/httpclient"
	openaipkg "github.com/Kevin-Lab777/sub2api/internal/pkg/openai"
...
// Fingerprint 缓存的指纹信息（User-Agent 等）
// [LITE:LOCAL] 原在 identity_service.go 中定义，Lite 版本删除了该文件，在此本地定义。
type Fingerprint struct {
	UserAgent string
}

// IdentityCache 身份缓存接口
// [LITE:LOCAL] 原在 identity_service.go 中定义，Lite 版本删除了该文件，在此本地定义。
