...
// [LITE] 移除了 emailService 和 turnstileService，保留 opsService
...
// [LITE] 移除了 EmailService 和 TurnstileService 参数
func NewSettingHandler(settingService *service.SettingService, opsService *service.OpsService, paymentConfigService *service.PaymentConfigService, paymentService *service.PaymentService) *SettingHandler {
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	// Turnstile 参数验证
	// [LITE] 移除 Turnstile 验证，Lite 模式不需要验证码
	if req.TurnstileEnabled {
		...
		// [LITE:DELETED] Turnstile 密钥验证已移除
	}
...
// [LITE:DELETED] TestSMTPRequest, TestSMTPConnection, SendTestEmailRequest, SendTestEmail
// 这些 SMTP 相关的测试功能在 Lite 模式中已移除，因为 Lite 不需要邮件服务
