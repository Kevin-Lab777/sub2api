...
func setupAdminRouter() (*gin.Engine, *stubAdminService) {
	...
	// [LITE:DELETED] redeemHandler — RedeemService removed
	...
	// [LITE:DELETED] redeem-codes routes — RedeemHandler removed
...
// [LITE:DELETED] TestRedeemHandlerEndpoints — RedeemHandler removed
