...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	if req.TurnstileEnabled {
		...
		// [LITE:DELETED] TurnstileService validation removed.
	}
...
func (h *SettingHandler) ensureDingTalkSyncAttributes(_ context.Context, _ *service.SystemSettings) {
	// [LITE:DELETED] UserAttributeService is not part of Lite.
}
