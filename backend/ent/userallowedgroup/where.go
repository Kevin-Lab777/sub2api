...
func ID(id int64) predicate.UserAllowedGroup {
	return predicate.UserAllowedGroup(sql.FieldEQ(FieldID, id))
}

// IDEQ applies the EQ predicate on the ID field.
func IDEQ(id int64) predicate.UserAllowedGroup {
	return predicate.UserAllowedGroup(sql.FieldEQ(FieldID, id))
}

// IDNEQ applies the NEQ predicate on the ID field.
func IDNEQ(id int64) predicate.UserAllowedGroup {
	return predicate.UserAllowedGroup(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...int64) predicate.UserAllowedGroup {
	return predicate.UserAllowedGroup(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...int64) predicate.UserAllowedGroup {
	return predicate.UserAllowedGroup(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id int64) predicate.UserAllowedGroup {
	return predicate.UserAllowedGroup(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id int64) predicate.UserAllowedGroup {
	return predicate.UserAllowedGroup(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id int64) predicate.UserAllowedGroup {
	return predicate.UserAllowedGroup(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id int64) predicate.UserAllowedGroup {
	return predicate.UserAllowedGroup(sql.FieldLTE(FieldID, id))
}
