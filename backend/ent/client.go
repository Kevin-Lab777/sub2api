...
import (
	...
	"github.com/Kevin-Lab777/sub2api/ent/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.PaymentProviderInstance, c.PendingAuthSession, c.Proxy, c.SecuritySecret,
		c.Setting, c.SubscriptionPlan, c.TLSFingerprintProfile, c.UsageCleanupTask,
		c.UsageLog, c.User, c.UserAllowedGroup, c.UserPlatformQuota,
		c.UserSubscription,
	} {
		n.Use(hooks...)
	}
...
type (
	hooks struct {
		...
		PaymentProviderInstance, PendingAuthSession, Proxy, SecuritySecret, Setting,
		SubscriptionPlan, TLSFingerprintProfile, UsageCleanupTask, UsageLog, User,
		UserAllowedGroup, UserPlatformQuota, UserSubscription []ent.Hook
	}
	inters struct {
		APIKey, Account, AccountGroup, Announcement, AnnouncementRead, AuthIdentity,
		AuthIdentityChannel, BatchImageEvent, BatchImageItem, BatchImageJob,
		...
		PaymentProviderInstance, PendingAuthSession, Proxy, SecuritySecret, Setting,
		SubscriptionPlan, TLSFingerprintProfile, UsageCleanupTask, UsageLog, User,
		UserAllowedGroup, UserPlatformQuota, UserSubscription []ent.Interceptor
	}
)
