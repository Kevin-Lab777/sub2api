...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "daily_limit_usd", Type: field.TypeFloat64, Nullable: true},
		{Name: "weekly_limit_usd", Type: field.TypeFloat64, Nullable: true},
		{Name: "monthly_limit_usd", Type: field.TypeFloat64, Nullable: true},
		{Name: "total_limit_usd", Type: field.TypeFloat64, Nullable: true},
		{Name: "daily_usage_usd", Type: field.TypeFloat64, Default: 0},
		{Name: "weekly_usage_usd", Type: field.TypeFloat64, Default: 0},
		{Name: "monthly_usage_usd", Type: field.TypeFloat64, Default: 0},
		{Name: "total_usage_usd", Type: field.TypeFloat64, Default: 0},
		{Name: "usage_reset_daily", Type: field.TypeTime, Nullable: true},
		{Name: "usage_reset_weekly", Type: field.TypeTime, Nullable: true},
		{Name: "usage_reset_monthly", Type: field.TypeTime, Nullable: true},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "messages_dispatch_model_config", Type: field.TypeJSON, Nullable: true},
	}
