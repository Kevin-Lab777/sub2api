...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminAuthService := service.NewAdminAuthService(userRepository, refreshTokenCache, configConfig, settingService)
	...
	authHandler := handler.NewAuthHandler(configConfig, adminAuthService, userService, settingService, totpService)
	...
	settingHandler := handler.ProvideAdminSettingHandler(settingService)
	...
	usageHandler := admin.NewUsageHandler(usageService, apiKeyService, adminService, usageCleanupService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, groupHandler, accountHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, settingHandler, opsHandler, systemHandler, usageHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, promptAdminHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	passkeyHandler := handler.NewPasskeyHandler(passkeyService, adminAuthService, settingService)
	idempotencyCoordinator := service.ProvideIdempotencyCoordinator(idempotencyRepository, configConfig)
	idempotencyCleanupService := service.ProvideIdempotencyCleanupService(idempotencyRepository, configConfig)
	handlers := handler.ProvideHandlers(authHandler, userHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, idempotencyCoordinator, idempotencyCleanupService)
	adminAuthMiddleware := middleware.NewAdminAuthMiddleware(adminAuthService, userService, settingService, auditLogService)
	...
	engine := server.ProvideRouter(configConfig, handlers, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, compositeRouteResolver, redisClient)
	...
	v := provideCleanup(client, redisClient, runtime, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, channelMonitorRunner, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, auditLogService, promptService)
