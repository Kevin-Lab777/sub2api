...
import { getPublicSettings as fetchPublicSettingsAPI } from '@/api/admin/settings'
...
export const useAppStore = defineStore('app', () => {
  ...
  const siteName = ref<string>('Sub2API Lite')
  ...
  function applySettings(config: PublicSettings): void {
    ...
    siteName.value = config.site_name || 'Sub2API Lite'
