  ...
  >
    ...
    <div class="mt-auto border-t border-gray-100 p-3 dark:border-dark-800">
      <router-link
        ...
        :class="{ 'sidebar-link-active': isActive('/profile'), 'sidebar-link-collapsed': sidebarCollapsed }"
      ...
      >
        ...
        <span class="sidebar-label" :class="{ 'sidebar-label-collapsed': sidebarCollapsed }" :aria-hidden="sidebarCollapsed ? 'true' : 'false'">{{ t('nav.profile') }}</span>
      </router-link>
...
const homePath = computed(() => '/admin/dashboard')
