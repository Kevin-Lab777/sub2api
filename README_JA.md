...
curl -sSL https://raw.githubusercontent.com/Kevin-Lab777/sub2api/Light/deploy/docker-deploy.sh | bash
...
<a href="https://star-history.com/#Kevin-Lab777/sub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Kevin-Lab777/sub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Kevin-Lab777/sub2api&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Kevin-Lab777/sub2api&type=Date" />
 </picture>
</a>
